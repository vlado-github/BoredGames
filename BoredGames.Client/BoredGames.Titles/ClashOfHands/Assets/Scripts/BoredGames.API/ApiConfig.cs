...
namespace Assets.BoredGames.API
{
    class ApiConfig
    {
        public static Uri BaseApiUrl = new Uri("https://localhost:7075");//new Uri("https://boredgames.lol/api/"); //new Uri("https://localhost:7075");
        public static Uri BaseHubUrl = new Uri("https://localhost:7075");//new Uri("https://boredgames.lol"); //new Uri("https://localhost:7075");
