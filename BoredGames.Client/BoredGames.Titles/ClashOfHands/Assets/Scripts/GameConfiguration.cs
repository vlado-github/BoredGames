namespace Assets.Scripts.GamePlay
{
    public sealed class GameConfiguration
    {
        ...
        public string PortalBaseUrl { get; private set; } = "http://localhost:5173/game?gameTitle=ClashOfHands";//"https://boredgames.lol/game?gameTitle=ClashOfHands"; //"http://localhost:5173/game?gameTitle=ClashOfHands";
    }
}