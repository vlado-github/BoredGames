...
namespace Assets.BoredGames.API
{
    class ApiConfig
    {
        public static Uri BaseApiUrl = new Uri("http://localhost:5208");//new Uri("https://boredgames.lol/api/"); //new Uri("https://localhost:7075"); //new Uri("http://localhost:5208");
        public static Uri BaseHubUrl =  new Uri("http://localhost:5208");//new Uri("https://boredgames.lol"); //new Uri("https://localhost:7075"); //new Uri("http://localhost:5208");
