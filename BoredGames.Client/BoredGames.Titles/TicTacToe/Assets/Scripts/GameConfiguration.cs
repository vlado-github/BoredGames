namespace Assets.Scripts.GamePlay
{
    public sealed class GameConfiguration
    {
        ...
        public int GameTitle { get; private set; } = 1;
        ...
        public string PortalBaseUrl { get; private set; } = "http://localhost:5173/game?gameTitle=TicTacToe";//"https://boredgames.lol/game?gameTitle=TicTacToe"; //"http://localhost:5173/game?gameTitle=TicTacToe";
    }
}