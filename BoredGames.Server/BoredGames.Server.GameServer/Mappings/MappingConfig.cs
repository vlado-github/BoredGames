...
namespace BoredGames.Server.GameServer.Mappings;

public static class MappingConfig
{
    public static void RegisterMappings(this IHostBuilder builder)
    {
        ...
        TypeAdapterConfig<Hand, RoundResultViewModel>
            .NewConfig()
            .Map(dest => dest.PlayerMove, src => src.PlayerMove)
